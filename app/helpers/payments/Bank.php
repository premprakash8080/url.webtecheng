    ...
    public static function settings(){
        ...
        $html = '<div class="form-group">
                ...
                <div class="form-group '.(!$config->enabled ? 'd-none':'').'">
                    <label for="bankinfo" class="form-label fw-bold">'.e('Bank Info').'</label>
                    <textarea class="form-control p-2" name="bank[info]" placeholder="" id="bankinfo">'.($config ? $config->info : '').'</textarea>
