...
final class Emails {
    ...
    public static function approveURL($link){
        ...
        $mailer->to(config('email'))
                ->send([
                    'subject' => '['.config("sitename").'] '.e('Please verify and approve this url'),
    ...
    public static function renewEmail($user){       
        ...
        $message = str_replace("{site.title}", config("sitename"), $strings['activation']);
        ...
        $mailer->to($user->email)
                ->send([
                    'subject' => '['.config("sitename").'] '.e('Please verify your email'),
                    'message' => function($template, $data) use ($message) {
                        if(config('logo')){
                            $title = '<img align="center" alt="'.config('sitename').'" border="0" class="center autowidth" src="'.uploads(config('logo')).'" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 166px; display: block;" title="'.config('sitename').'" width="166"/>';
                        } else {
    ...
    public static function registered($user){
        ...
        $message = str_replace("{site.title}", config("sitename"), $strings['registration']);
        $message = str_replace("{site.link}", config("url"), $message);
        $message = str_replace("{user.username}", $user->username ?? '', $message);
        ...
        $mailer->to($user->email)
                ->send([
                    'subject' => '['.config("sitename").'] '.e('Registration has been successful'),
                    'message' => function($template, $data) use ($message) {
                        if(config('logo')){
                            $title = '<img align="center" alt="'.config('sitename').'" border="0" class="center autowidth" src="'.uploads(config('logo')).'" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 166px; display: block;" title="'.config('sitename').'" width="166"/>';
                        } else {
    ...
    public static function reset($user){
        ...
        $message = str_replace("{site.title}", config("sitename"), $strings['passwordreset']);
        $message = str_replace("{site.link}", config("url"), $message);
        $message = str_replace("{user.username}", $user->username ?? '', $message);
        ...
        $mailer->to($user->email)
                ->send([
                    'subject' => '['.config("sitename").'] '.e('Password Reset Instructions'),
                    'message' => function($template, $data) use ($message) {
                        if(config('logo')){
                            $title = '<img align="center" alt="'.config('sitename').'" border="0" class="center autowidth" src="'.uploads(config('logo')).'" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 166px; display: block;" title="'.config('sitename').'" width="166"/>';
                        } else {
    ...
    public static function activate($user){
        ...
        $message = str_replace("{site.title}", config("sitename"), $strings['success']);
        $message = str_replace("{site.link}", config("url"), $message);
        $message = str_replace("{user.username}", $user->username ?? '', $message);
        $message = str_replace(["https://{user.activation}", "http://{user.activation}", "{user.activation}"],  "", $message);
        $message = str_replace("{user.email}", $user->email, $message);
        ...
        $mailer->to($user->email)
                ->send([
                    'subject' => '['.config("sitename").'] '.e('Your email has been verified'),
                    'message' => function($template, $data) use ($message) {
                        if(config('logo')){
                            $title = '<img align="center" alt="'.config('sitename').'" border="0" class="center autowidth" src="'.uploads(config('logo')).'" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 166px; display: block;" title="'.config('sitename').'" width="166"/>';
                        } else {
    ...
    public static function passwordChanged($user){
        ...
        $mailer->to($user->email)
                ->send([
                    'subject' => '['.config("sitename").'] '.e('Your password was changed.'),
    ...
    public static function affiliatePayment($user, $amount){
        ...
        $mailer->to($user->email)
                ->send([
                    'subject' => '['.config("sitename").'] '.e('You just got paid!'),
    ...
    public static function invite($user){
        ...
        $message = str_replace("{site.title}", config("sitename"), $strings['teaminvitation']);
        $message = str_replace("{site.link}", config("url"), $message);
        $message = str_replace("{user.username}", $user->username ?? '', $message);
        ...
        $mailer->to($user->email)
                ->send([
                    'subject' => '['.config("sitename").'] '.e('You have been invited to join our team'),
                    'message' => function($template, $data) use ($message) {
                        if(config('logo')){
                            $title = '<img align="center" alt="'.config('sitename').'" border="0" class="center autowidth" src="'.uploads(config('logo')).'" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 166px; display: block;" title="'.config('sitename').'" width="166"/>';
                        } else {
    ...
    public static function reset2FA($user){       
        ...
        $message = str_replace("{site.title}", config("sitename"), $strings['verify2fa']);
        $message = str_replace("{site.link}", config("url"), $message);
        $message = str_replace("{user.username}", $user->username ?? '', $message);
        $message = str_replace(["https://{user.activation}", "http://{user.activation}", "{user.activation}"],  $activate, $message);
        $message = str_replace("{user.email}", $user->email, $message);
        ...
        $mailer->to($user->email)
                ->send([
                    'subject' => '['.config("sitename").'] '.e('Please verify your email to reset your 2FA'),
                    'message' => function($template, $data) use ($message) {
                        if(config('logo')){
                            $title = '<img align="center" alt="'.config('sitename').'" border="0" class="center autowidth" src="'.uploads(config('logo')).'" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 166px; display: block;" title="'.config('sitename').'" width="166"/>';
                        } else {
    ...
    public static function newip($user){       
        ...
        $message = str_replace("{site.title}", config("sitename"), $strings['newip']);
        $message = str_replace("{site.link}", config("url"), $message);
        $message = str_replace("{user.username}", $user->username ?? '', $message);
        $message = str_replace(["https://{user.activation}", "http://{user.activation}", "{user.activation}"],  '', $message);
        $message = str_replace("{user.email}", $user->email, $message);
