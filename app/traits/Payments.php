    ...
    public function processor($type = null, $action = null){
        ...
        $list = [			
			...
			'mollie' => [
                ...
                'config' => ['single' => true, 'subscription' => true],
				'settings' => [Mollie::class, 'settings'],
				'save' => null,
				'checkout' => [Mollie::class, 'checkout'],
				'payment' => [Mollie::class, 'payment'],
				'subscription' => null,
				'webhook' => [Mollie::class, 'webhook'],
				'createplan' => null,
				'updateplan' => null,
				'syncplan' => null,
				'cancel' =>  [Mollie::class, 'cancel'],
				'createcoupon' => null,
				'createtax' => null,
				'manage' => null,
			],
			...
			'paddlebilling' => [
				...
				'config' => ['single' => true, 'subscription' => true],
				'settings' => [PaddleBilling::class, 'settings'],
				'save' => null,
				'checkout' => [PaddleBilling::class, 'checkout'],
				'payment' => [PaddleBilling::class, 'payment'],
				'webhook' => [PaddleBilling::class, 'webhook'],
				'createplan' =>  [PaddleBilling::class, 'createplan'],
				'updateplan' =>  [PaddleBilling::class, 'updateplan'],
				'syncplan' =>  [PaddleBilling::class, 'syncplan'],
				'cancel' => [PaddleBilling::class, 'cancel'],
				'createcoupon' =>  [PaddleBilling::class, 'createcoupon'],
				'createtax' => null,
				'manage' => [PaddleBilling::class, 'manage']
			],			
			'paddle' => [
