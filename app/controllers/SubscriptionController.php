...
class Subscription {
    ...
    public function pricing(){        
        ...
        View::set('title', e('Pricing Plans - Premium URL Shortener Features & Pricing'));
        View::set('description', e('Choose the perfect plan for your URL shortening needs. Free plan available with basic features. Upgrade to premium for advanced analytics, custom domains, QR codes, and more.'));
        View::set('keywords', 'URL shortener pricing, premium URL shortener, URL shortener plans, link shortener pricing, short URL pricing');
