            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6 pr-lg-5">
                    <h1 class="display-3 <?php echo themeSettings::config('homestyle', 'light', 'text-dark', 'text-white') ?> font-weight-bolder mb-4">
                        Free URL Shortener - Create Short Links & Track Clicks
                    </h1>
                    <div class="lead <?php echo themeSettings::config('homestyle', 'light', 'text-dark', 'text-white') ?> opacity-8">
                        <p>Transform long URLs into short, shareable links with our free URL shortener. Create custom short links, generate QR codes, track click analytics, and manage your links with our powerful link shortener tool. Perfect alternative to TinyURL and bit.ly.</p>
                    </div>
                    <?php message() ?>
    ...
    <section class="slice slice-lg">
        <div class="container pt-6 pt-lg-8">
            <div class="mb-8 text-center">
                <h2>Free URL Shortener with Advanced Features</h2>
                <div class="fluid-paragraph mt-3">
                    <p class="lead lh-180">
                        Our free URL shortener provides everything you need to shorten links, track performance, and optimize your marketing campaigns. Create short URLs, custom aliases, QR codes, and bio pages - all in one powerful platform. Perfect for businesses, marketers, and content creators who need a reliable link shortener tool.
                    </p>
                </div>
            </div>
    ...
    <section class="slice">
        <div class="container">
            <div class="my-10">
                <div class="row row-grid justify-content-between align-items-center">
                    <div class="col-lg-5 order-lg-2">
                        <h3>Advanced Link Analytics & Tracking</h3>
                        <p class="lead my-4">
                            Track every click with detailed analytics including geographic location, device type, browser, referrer sources, and click timestamps. Our URL shortener provides comprehensive insights to help you understand your audience and optimize your marketing campaigns for better conversion rates.
                        </p>
            ...
            <div class="my-10">
                <div class="row row-grid justify-content-between align-items-center">
                    <div class="col-lg-5">
                        <h3>Professional Link Management Features</h3>
                        <p class="lead my-4">
                            Manage your short links with powerful features including password protection, link expiration dates, custom aliases, branded domains, and bulk link management. Our free URL shortener offers enterprise-level features to help you maintain control over your links and brand.
                        </p>
                        <ul class="list-unstyled mb-0">
                            <li class="py-2">
                                <div class="d-flex align-items-center">
            ...
            <div class="my-10">
                <div class="row row-grid justify-content-between align-items-center">
                    ...
                    <div class="col-lg-5">
                        ...
                        <p class="lead my-4">
                            Generate custom QR codes for any URL with our free QR code generator. Create branded QR codes with custom colors, logos, and designs. Track QR code scans and analyze performance. Perfect for print materials, business cards, and marketing campaigns.
                        </p>
