...
<div class="card rounded-4 card-body shadow-sm mb-4">
    <div class="align-items-center">
        <?php view('partials.stats_nav', ['url' => $url]) ?>
    </div>
</div>
<div class="d-flex mb-4 align-items-center">
    <h3 class="mb-0 fw-bold"><?php ee('Platforms') ?></h3>
    <div class="ms-auto ml-auto card rounded-4 mb-0 shadow-sm p-2">
    ...
    <div class="col-md-8">              
        <div class="card rounded-4 shadow-sm mb-0">                                
            <div class="card-body px-4">
                <canvas data-trigger="dynamic-pie" data-url="<?php echo route('data.platforms', [$url->id]) ?>" data-type="os" style="min-height:200px"></canvas>
            </div>
        </div>
    </div>
    <div class="col-md-4">
