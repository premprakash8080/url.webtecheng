...
<h1 class="h3 mb-5 fw-bold"><?php ee('Edit Plan') ?></h1>
    ...
    <div class="card-body">
        <form method="post" action="<?php echo route('admin.plans.update', [$plan->id]) ?>" enctype="multipart/form-data">
            ...
            <div class="mb-4 rounded p-3 border">
                <h4 class="fw-bold mb-4"><?php ee('Plan Information') ?></h4>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group mb-4">
                            <label for="name" class="form-label fw-bold"><?php ee('Name') ?></label>
                            <input type="text" class="form-control p-2" name="name" id="name" value="<?php echo $plan->name ?>" placeholder="My Sample Plan">
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control p-2" name="description" id="description" value="<?php echo $plan->description ?>" placeholder="Plan description">
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control p-2" name="icon" id="icon" value="<?php echo $plan->icon ?>" placeholder="Icon class" autocomplete="off">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-select p-2" name="status" id="status">
                                <option value="0" <?php echo !$plan->status ? 'selected' : '' ?>> <?php ee('Disabled') ?></option>
                                <option value="1" <?php echo $plan->status ? 'selected' : '' ?>> <?php ee('Enabled') ?></option>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-select p-2" name="hidden" id="hidden">
                                <option value="0" <?php echo !$plan->hidden ? 'selected' : '' ?>> <?php ee('Visible') ?></option>
                                <option value="1" <?php echo $plan->hidden ? 'selected' : '' ?>> <?php ee('Hidden') ?></option>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-select p-2" name="popular" id="popular">
                                <option value="0" <?php echo !$plan->ispopular ? 'selected' : '' ?>> <?php ee('Disabled') ?></option>
                                <option value="1" <?php echo $plan->ispopular ? 'selected' : '' ?>> <?php ee('Enabled') ?></option>
                            </select>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group mb-4  <?php echo $plan->free ? 'd-none': '' ?>">
                            ...
                            <input type="text" class="form-control p-2" name="trial" id="trial" value="<?php echo $plan->trial_days ?>" placeholder="e.g. 7">
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-4  <?php echo $plan->free ? 'd-none': '' ?>">
                            ...
                            <input type="text" class="form-control p-2" name="price_monthly" id="price_monthly" value="<?php echo $plan->price_monthly ?>" placeholder="e.g. 9.99">
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-4  <?php echo $plan->free ? 'd-none': '' ?>">
                            ...
                            <input type="text" class="form-control p-2" name="price_yearly" id="price_yearly" value="<?php echo $plan->price_yearly ?>" placeholder="e.g. 99.99">
                            <p class="form-text"><?php ee('To change your currency, you need to change it in the settings page.') ?></p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group mb-4  <?php echo $plan->free ? 'd-none': '' ?>">
                            ...
                            <input type="text" class="form-control p-2" name="price_lifetime" id="price_lifetime" value="<?php echo $plan->price_lifetime ?>" placeholder="e.g. 999.99">
                            <p class="form-text"><?php ee('To change your currency, you need to change it in the settings page.') ?></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4">
                                <div class="form-group mb-4">
                                    ...
                                    <select class="form-select p-2" name="counttype" id="counttype">
                                        <option value="total" <?php echo isset($plan->counttype) && $plan->counttype == 'total' ? 'selected' : '' ?>> <?php ee('Total') ?></option>
                                        <option value="monthly" <?php echo isset($plan->counttype) && $plan->counttype == 'monthly' ? 'selected' : '' ?>> <?php ee('Monthly - Resets each month') ?></option>
                                    </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control p-2" name="numurls" id="numurls" value="<?php echo $plan->numurls ?>" placeholder="e.g. 10">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control p-2" name="numclicks" id="numclicks" value="<?php echo $plan->numclicks ?>" placeholder="e.g. 1000">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control p-2" name="retention" id="retention" value="<?php echo $plan->retention ?>" placeholder="e.g. 15">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control p-2" name="permission[custom]" id="permission-custom" value="<?php echo $plan->permission->custom ?? '' ?>" placeholder="e.g. Phone Support">
                ...
                <div class="row mt-4">
                    <?php $i=0; foreach(\Helpers\App::features() as $slug => $feature): ?>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="border rounded rounded-4-3 p-3 h-100">
                                <div class="form-group mb-4">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" data-binary="true" id="permission-<?php echo $slug ?>-enabled" name="permission[<?php echo $slug ?>][enabled]" value="1" <?php echo ($feature['count'] || isset($feature['custom']) ? 'data-toggle="togglefield" data-toggle-for="permission-'.$slug.'-count,permission-'.$slug.'-custom"' : '') ?> <?php if(isset($plan->permission->{$slug}) && $plan->permission->{$slug}->enabled) echo "checked" ?>>
                                ...
                                <?php if($feature['count']): ?>
                                    <div class="form-group mb-4 <?php if(!isset($plan->permission->{$slug}) || !$plan->permission->{$slug}->enabled) echo "d-none" ?>">
                                        <label for="permission-<?php echo $slug ?>-count" class="form-label fw-bold"><?php ee($feature['name']) ?></label>
                                        <input type="text" class="form-control p-2" name="permission[<?php echo $slug ?>][count]" id="permission-<?php echo $slug ?>-count" placeholder="e.g. 10" value="<?php echo $plan->permission->{$slug}->count ?? '' ?>">
                                        ...
                                        <?php if($slug == 'qr'): ?>
                                            <div>
                                                ...
                                                <select class="form-select p-2" name="qrcounttype" id="qrcounttype">
                                                    <option value="total" <?php echo isset($plan->qrcounttype) && $plan->qrcounttype == 'total' ? 'selected' : '' ?>> <?php ee('Total') ?></option>
                                                    <option value="monthly" <?php echo isset($plan->qrcounttype) && $plan->qrcounttype == 'monthly' ? 'selected' : '' ?>> <?php ee('Monthly - Resets each month') ?></option>
                                                </select>
                                ...
                                <?php if(isset($feature['custom'])): ?>
                                    <div class="form-group mb-4 <?php if(!$plan->permission->{$slug}->enabled || !isset($plan->permission->{$slug}->custom)) echo "d-none" ?>">
                                        ...
                                        <?php if($feature['custom']['type'] == 'input'): ?>
                                            <input type="text" class="form-control p-2" name="permission[<?php echo $slug ?>][custom]" id="permission-<?php echo $slug ?>-custom" value="<?php echo $plan->permission->{$slug}->custom ?? '' ?>">
                                        <?php endif ?>
                                        <?php if($feature['custom']['type'] == 'select'): ?>
                                            <?php $list = isset($plan->permission->{$slug}->custom) ? explode(',', $plan->permission->{$slug}->custom) : [];?>
                                            <div class="input-select" id="permission-<?php echo $slug ?>-custom">
                                                <select multiple="multiple" class="form-select p-2" name="permission[<?php echo $slug ?>][custom][]" data-toggle="select">
                                                    <?php foreach($feature['custom']['data'] as $data): ?>
                                                        <option value="<?php echo $data ?>" <?php echo in_array($data, $list) ? 'selected' : '' ?>><?php echo $data ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                            </div>
                                        <?php endif ?>
            ...
            <button type="submit" class="btn btn-primary px-5 py-2 rounded-3 shadow-sm mt-2"><?php ee('Update Plan') ?></button>
        </form>
    </div>
</div>