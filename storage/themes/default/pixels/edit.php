<div class="d-flex mb-5">
    ...
    <div class="ms-auto">
        <a href="<?php echo route('links', ['pixel' => "{$pixel->type}-{$pixel->id}"]) ?>" class="btn btn-primary rounded-3 px-3 py-2"><i data-feather="plus"></i> <?php ee('View Links') ?></a>
    </div>    
</div>
<div class="row">
    <div class="col-md-8">
        <div class="card rounded-4 shadow-sm">
            <div class="card-body">
                <form method="post" action="<?php echo route('pixel.update', [$pixel->id]) ?>" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                <label for="pixel" class="form-label fw=bold"><?php ee('Pixel Name') ?></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                <label for="tag" class="form-label fw=bold"><?php echo e("Pixel Tag") ?></label>
                    ...
                    <button type="submit" class="btn btn-primary rounded-3 px-3 py-2"><?php ee('Update Pixel') ?></button>
                </form>
            </div>
        </div>               
    </div>    
