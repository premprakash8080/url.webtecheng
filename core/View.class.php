...
final class View extends Gem {
  ...
  public static function title($separator = "-", $sitetitle = true){
    if(empty(self::$title)){
      return self::$Config->sitename;
    }else{
      return self::$title.(self::$Config->sitename ? " ".$separator." ".self::$Config->sitename : "");
    }
  }
  /**
  ...
  */
  ...
  public static function meta(){
    ...
    echo "<meta property=\"og:site_name\" content=\"".self::$Config->sitename."\" />\n\t";
    if(!empty(self::$image)) {
      echo "<meta property=\"og:image\" content=\"".self::image()."\" />\n\t";
      echo "<meta property=\"og:image:width\" content=\"1200\" />\n\t";
      echo "<meta property=\"og:image:height\" content=\"630\" />\n\t";
      echo "<meta property=\"og:image:alt\" content=\"".self::title()."\" />\n\t";
    } else {
      // Default OG image if none set
      $defaultImage = self::$Config->url."/".self::ASSET."/images/landing.png";
    ...
    if(!empty(self::$image)) {
      echo "<meta name=\"twitter:image\" content=\"".self::image()."\">\n\t";
      echo "<meta name=\"twitter:image:alt\" content=\"".self::title()."\">\n\t";
    } else {
      $defaultImage = self::$Config->url."/".self::ASSET."/images/landing.png";
      echo "<meta name=\"twitter:image\" content=\"".$defaultImage."\">\n\t";
    }
    echo "<meta name=\"twitter:domain\" content=\"".str_replace("http://", "", str_replace("https://", "", self::$Config->url))."\">\n\t";
